              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.story.update') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      ...
                      <div class="send-header">
                        ...
                        <div class="form-group">
                        	<img src="{{ url('/thumbnail/') }}/{{ $record->story_image }}" width="100px;" height="100px;"></td>
                        </div>

                        <div class="form-group">
                          <textarea name="description" class="form-control" placeholder="Description..." rows='10'>{{ $record->description_en }}</textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="checkbox" name="our_story" <?php if(isset($record->our_story) && $record->our_story == 1){ echo "checked"; } ?> class="form-check-input" value="1">Our Story
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="checkbox" name="success_story" <?php if(isset($record->success_story) && $record->success_story == 1){ echo "checked"; } ?> class="form-check-input" value="1">Success Story
                        </label>
                      </div>
                      <div class="form-check-inline">
                        <label class="form-check-label">
                          <input type="checkbox" name="news" <?php if(isset($record->news) && $record->news == 1){ echo "checked"; } ?> class="form-check-input" value="1">News
                        </label>
                      </div>
