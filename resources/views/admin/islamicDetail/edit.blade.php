              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.islamic_detail.update') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      
                      <input type="hidden" name="id" value="{{ $record->id }}">
                      <h4 class="c-grey-900 mB-20">Update Islamic Page</h4>
					  ...
					  <br/>
                      <input type="checkbox" name="marhomeen" value="1" <?php if(isset($record->marhomeen) && $record->marhomeen == 1){ echo "checked"; } ?> /> Marhomeen
					  
					  <br/>
                      <input type="checkbox" name="calender" value="1" <?php if(isset($record->calender) && $record->calender == 1){ echo "checked"; } ?> /> Calendar
