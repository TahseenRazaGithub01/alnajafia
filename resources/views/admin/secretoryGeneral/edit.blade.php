              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.secratory_general.update') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      ...
                      <div class="send-header">
                        ...
                        <div class="form-group">
                          <img src="{{ url('/thumbnail/') }}/{{ $record->banner_image }}" width="450px;" height="150px;"></td>
                        </div>

                        <div class="form-group">
                          <input type="text" required="required" class='form-control' name="title" value="{{ $record->title_en }}" placeholder="Title">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <img src="{{ url('/thumbnail/') }}/{{ $record->message_image }}" width="140px;" height="150px;"></td>
                        </div>


                        <div class="form-group">
                          <textarea name="message_description" class="form-control" placeholder="Message Description..." rows='10'>{{ $record->message_description_en }}</textarea>
                        </div>
                      </div>
