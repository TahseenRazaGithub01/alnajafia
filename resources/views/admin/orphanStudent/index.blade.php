              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.orphan.student.store') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      <h4 class="c-grey-900 mB-20">Add New Orphan Student</h4>
                      <div class="send-header">
                        ...
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" checked="checked" name="gender" value="male">Male
                            &nbsp; &nbsp; &nbsp; &nbsp;
                        ...
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" checked="checked" name="orphan_type" value="basic">Basic Care
                            &nbsp; &nbsp; &nbsp; &nbsp;
                            <input type="radio" class="form-check-input" name="orphan_type" value="zehra">Dar Al Zehra
                          </label>
                        </div>

                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="cast" value="syed">Syed
                            &nbsp; &nbsp; &nbsp; &nbsp;
                            <input type="radio" class="form-check-input" checked="checked" name="cast" value="non-syed">Non Syed
                          </label>
                        </div>
                        ...
                        <div class="form-group">
                          <input type="text" required="required" class='form-control' name="orp_profile_id" placeholder="897601">
                        </div>
                        ...
                        <label class="switch">
                          <input type="checkbox" name="student_status" checked >
