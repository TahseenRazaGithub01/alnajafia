              ...
              <div class="email-wrapper row remain-height pos-r scrollable bgc-white">
                <div class="email-content open no-inbox-view">
                  <div class="email-compose">
                    ...
                    <form method="post" action="{{ route('admin.gallery.store') }}" enctype="multipart/form-data" class="email-compose-body">
                      @csrf
                      <h4 class="c-grey-900 mB-20">Add New Image / Video</h4>
                      <div class="send-header">
                        <div class="form-group">
                          <input type="text" required="required" class='form-control' name="title" placeholder="Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <input type="url" class='form-control' name="youtube_url" placeholder="https://example.com" pattern="https://.*">
                        </div>
                      </div>
