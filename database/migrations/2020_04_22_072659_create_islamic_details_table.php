...
class CreateIslamicDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('islamic_details', function (Blueprint $table) {
            ...
            $table->boolean('marhomeen')->default(0);
            $table->boolean('calender')->default(0);
    ...
    {
        Schema::dropIfExists('islamic_details');
    }
}
